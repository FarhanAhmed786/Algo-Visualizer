...
function Navbar({clickBtn}) {
  return (
   <>
     <div className="h-15 nav-class bg-[#71c975]  justify-between text-white flex p-5 gap-10 text-xl flex-wrap ">
     <div className="sm:flex-grow-[3] ">
           <p className='p-tag '>SORTING ALGORITHM</p>
        </div>    
     <div className="sm:flex-grow-[2] flex space-x-6 flex-wrap justify-center text-white items-center ">
